...
module.exports = [
  ...
  },
  {
    ...
    execute: function(message, db) {
      ...
      .catch(function(){
        db.post(message.channel, templates.tracks());
      })
  ...
  },
  {
    ...
    execute: function(message, db) {
      ...
      .then(function(length){
        db.logger.info('Shuffling tracklist from %d to %d', index+1, length-1);
        return db.mopidy.tracklist.shuffle(index+1, length-1);
      })
      .catch(function(){
        db.post(message.channel, templates.tracks());
      })
