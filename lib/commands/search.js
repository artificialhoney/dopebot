...
module.exports = {
  ...
  handler: function (argv) {
    ...
    argv.db.logger.info('Searching for "%s" in types:', argv.query, argv.types)

    argv.db.spotify.search(argv.query, argv.types, {
    ...
    .then(function (data) {
      ...
      argv.db.post(argv.db.templates.search(argv.db.search.results))
    })
    .catch(function (err) {
